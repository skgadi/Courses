...
\newcommand{\ExamType}{Exam 1: Max time (1 hour 30 min)}
\newcommand{\Date}{07/03/2017}
...
\begin{document}
	...
	{%
		...
		\begin{enumerate}
			...
			\end{enumerate}
			\item Beyond which atomic number the elements show the property of radioactive decay (or nuclear decay)? (1 points)
