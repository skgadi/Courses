...
\newcommand{\ExamType}{Homework 3: Transistors}
\newcommand{\Date}{23/02/2017}
...
\begin{document}
	...
	{%
		...
		\section*{Questions}
		\begin{enumerate}
			\item Write a short note with circuit diagrams on CB, CC and CE mode of operations in a transistor. (10 point)
		\end{enumerate}
