...
\begin{document}
	...
	{%
		...
		\begin{enumerate}
			...
			\item Find the inverse Z-transform of the following function. (3 points) $$F(z)=\frac{\VarOOJ}{1-z^{-1}}$$
			\item Draw block diagram for the following transfer function. (3 points) $$\frac{y(z)}{x(z)}=\frac{z^2+{\VarOOK}z+{\VarOOO}}{{\VarOOL}z^2+{\VarOOM}z+{\VarOON}}$$
		\end{enumerate}
