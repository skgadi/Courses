...
\begin{document}
	...
	{%
		...
		\section*{Questions}
		\begin{enumerate}
			\item  Let $Z_1=\SI{-j{\VarOOA}}{\ohm}$, $Z_2=\SI{+j{\VarOOB}}{\ohm}$, $Z_3=\SI{{\VarOOC}}{\ohm}$, $Z_4=\SI{{\VarOOD}}{\ohm}$, $Z_5=\SI{{\VarOOE}}{\ohm}$, $Z_6=\SI{{\VarOOF}+j{\VarOOG}}{\ohm}$, $V_1=\SI{{\VarOOH}}{\volt}$ and $V_2=\SI{{\VarOOI}+j{\VarOOJ}}{\ohm}$. Find the current and votage across each element in the circuit shown in Figure 1.  (5 points)
